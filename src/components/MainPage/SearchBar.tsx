...
export default function SearchBar() {
	return (
		<div className="flex items-center  rounded-sm overflow-hidden focus-within:ring-2 focus-within:ring-yellow-200 duration-300 w-2/5 mx-auto mt-20 bg-white shadow-xl">
